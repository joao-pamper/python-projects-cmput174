'''
This program should decrypt messages using various combinations of three methods
of decryption
Author: Joao Pedro Amaral Pereira
When: February 3, 2023
References:
ord() -> converts letters to their ASCII code
chr() -> opposite of ord() https://www.toppr.com/guides/python-guide/examples/python-examples/python-program-find-ascii-value-character/#:~:text=What%20is%20CHR%20()%20in,parameter%20is%20the%20ASCII%20code.
...
def main() -> None:
    ...
    comb_1 = decrypt_atbash(caesar_result)
    comb_2 = decrypt_caesar(atbash_result,shift)
    comb_3 = decrypt_caesar(a1z26_result, shift)
    comb_4 = decrypt_atbash(a1z26_result)
    comb_5 = decrypt_caesar(decrypt_atbash(a1z26_result), shift)
    comb_6 = decrypt_atbash(decrypt_caesar(a1z26_result, shift))
    print('Caesar cipher: ' + str(caesar_result))
    print('Atbash cipher: ' + str(atbash_result))
    print('Combined: 1) Caesar; 2) Atbash cipher: ' + str(comb_1))
    print('Combined: 1) Caesar; 2) Caesar cipher: ' + str(comb_2))
    print('A1Z26 cipher: ' + str(a1z26_result))
    print('Combined: 1) A1Z26; 2) Caesar cipher: ' + str(comb_3))
    print('Combined: 1) A1Z26; 2) Atbash cipher: ' + str(comb_4))
    print('Combined: 1) A1Z26; 2) Atbash; 3) Caesar cipher: ' + str(comb_5))
    print('Combined: 1) A1Z26; 2) Caesar; 3) Atbash cipher: ' + str(comb_6))
    # text deciphered with all combinations of methods
main()